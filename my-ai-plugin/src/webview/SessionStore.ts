...
export class SessionStore {
  ...
  public persist(activeSessionId: string): ReturnType<typeof buildUpdateSessionsResponse> {
    this._sessions = sortSessionsByUpdatedAt(this._sessions);
    this.globalState.update('chatSessions', this._sessions);
    this.globalState.update('activeSessionId', activeSessionId);
    return buildUpdateSessionsResponse(this._sessions, activeSessionId);
  }
}
